...
import com.diandianguanjia.newrecycledemo3.mode.Headerbean;
import com.diandianguanjia.newrecycledemo3.mode.HomeCategory;
import com.diandianguanjia.newrecycledemo3.mode.RefreshBean;
import com.diandianguanjia.newrecycledemo3.view.AsHomepageHeaderView;
import com.diandianguanjia.newrecycledemo3.view.ImageUtils;
import com.diandianguanjia.newrecycledemo3.view.MyStaggerGrildLayoutManger;
        ...
        public TypeheadHolder(View view) {
            ...
            hview.setMoreclicklistenser(new AsHomepageHeaderView.MoreclickListenser() {
                ...
                public void setmoreclicklistenser() {
                    ...
                    Toast.makeText(mContext, "点击头部了", Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
